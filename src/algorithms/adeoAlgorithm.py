...
class AdeoAlgorithm(BaseAlgorithm):
    """
    ...
    def execute_algorithm(self, adapted_data: Dict[str, Any]) -> pd.DataFrame:
        ...
        try:
            ...
            # Initialize compensation day variables before if workers: block to avoid UnboundLocalError
            contingente_f = []
