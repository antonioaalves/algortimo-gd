...
def read_data_salsa_esp(medium_dataframes: Dict[str, pd.DataFrame]) -> Tuple[Any, ...]:
    """
    ...
    try:
        ...
        # Extract DataFrames
        # matriz_colaborador_gd = pd.read_csv('src/algorithms/shift_scheduler/data/matriz_colaborador_salsa_esps3.csv', sep=';',  engine='python')
        # matriz_estimativas_gd = pd.read_csv('src/algorithms/shift_scheduler/data/matriz_estimativas_salsa_esps2.csv', index_col=0)
        # matriz_calendario_gd = pd.read_csv('src/algorithms/shift_scheduler/data/matriz_calendario_salsa_esps3.csv', index_col=0)
