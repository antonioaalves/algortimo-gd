def compensation_days(model, shift, workers, working_days, holidays, start_weekday, week_to_days, contract_type, working_shift):
    ...
    for w in workers:
        if contract_type[w] in [4, 5, 6]:
            ...
            for d in [day for day in holidays if day in working_days[w]]:
...
"""This file contains the constraints for the Salsa esp shift scheduler."""
