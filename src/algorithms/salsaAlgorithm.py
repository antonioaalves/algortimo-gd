...
class SalsaAlgorithm(BaseAlgorithm):
    ...
    def execute_algorithm(self, adapted_data: Dict[str, Any]) -> pd.DataFrame:
        ...
        try:
            ...
            if country == "spain":
                compensation_days(model, shift, workers_complete, working_days, holidays, start_weekday, week_to_days, working_shift, week_compensation_limit, fixed_days_off, fixed_LQs, worker_absences)
