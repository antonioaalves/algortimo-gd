...
class AlcampoAlgorithm(BaseAlgorithm):
    ...
    def execute_algorithm(self, adapted_data: Dict[str, Any]) -> pd.DataFrame:
        ...
        try:
            ...
            schedule_df = solve(model, days_of_year, workers_complete, special_days, shift, shifts, "normal", output_filename=os.path.join(ROOT_DIR, 'data', 'output', f'working_schedule_{self.process_id}-stage1.xlsx'))
            ...
            final_schedule_df = solve(new_model, days_of_year, workers_complete, special_days, new_shift, shifts, "normal", output_filename=os.path.join(ROOT_DIR, 'data', 'output', f'working_schedule_{self.process_id}-stage2.xlsx'))
    ...
    def format_results(self, algorithm_results: pd.DataFrame = pd.DataFrame()) -> Dict[str, Any]:
        ...
        try:
            ...
            # TODO: check what is the default logic
